...
const app = new Vue({
  ...
  methods: {
    ...
    onChangeCardType:function(event) {
      const value=event.target.value;
      const elmVipCard=document.getElementById('vipcard');
      const elmPreCard=document.getElementById('precard');
      const elmCard=document.getElementsByClassName('small-img-group');
      elmVipCard.style.display=value=='vipCard'?'block':'none';
      elmPreCard.style.display=value=='preCard'?'block':'none';
      elmCard.style.width ='100%';
  }
  } 
});